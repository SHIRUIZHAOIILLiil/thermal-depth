...
output_dir="outputs/lotus_line_v1/adapter_unet_caption_model_empty_official_val_full"
log_file="logs/adapter_unet_caption_model_empty_official_val_full.log"
pid_file="logs/adapter_unet_caption_model_empty_official_val_full.pid"
