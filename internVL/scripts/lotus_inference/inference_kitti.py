...
def main():
    # NYU dataset paths
    tar_path = 'lotus/datasets/eval/depth/kitti/kitti_eigen_split_test.tar'
    filename_list_path = 'lotus/datasets/eval/depth/data_split/kitti/eigen_test_files_with_gt.txt'
    output_file = 'outputs/lotus/kitti_depth_descriptions.json'
