...
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-output/iris_d/train-lotus-d-depth}"
export OUTPUT_DIR="${OUTPUT_DIR:-output/Depth_D_Eval_Iris}"
export TASK_NAME="depth"

export MODE="regression"

CUDA_VISIBLE_DEVICES="${CUDA:-0}" python eval_rng.py \
