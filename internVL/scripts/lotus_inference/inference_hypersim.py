...
def find_all_images(base_dir):
    ...
    for preview_dir in base_path.rglob('*final_preview'):
        for img_file in preview_dir.glob('*.jpg'):
            image_files.append(img_file)
    
    return sorted(image_files)

def main():
    base_dir = 'lotus/data/hypersim/train'
    output_file = 'outputs/lotus/hypersim_depth_descriptions.json'
