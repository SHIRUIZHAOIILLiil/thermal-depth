...
>
> 五帧样本（任务 3 的图，按远端挑的，不是为天空挑的）：
>
> | 帧 | GT 有回波中位 | b | c2 | d2 |
> |---|---:|---:|---:|---:|
> | 000703 | **25.3** | 11.1 | 9.1 | 10.2 |
> | 001245 | 11.9 | 12.0 | 10.1 | 10.7 |
> | 001445 | 14.8 | 14.6 | 11.6 | 15.6 |
> | 001958 | **21.7** | 14.5 | 13.5 | 9.3 |
> | 002403 | 9.4 | 11.4 | 10.3 | 15.1 |
>
> 只有 000703 和 001958 的上带确实含远处结构（GT >20 m），那两帧三条线都把整带压到
> 9–15 m。另外三帧上带本来就是近处建筑，没有信号。**5 帧里 2 帧 —— 是佐证，不是结论。**
> 要变成结论只需把 `--frame-ids` 换成全量，不需要写新工具。
