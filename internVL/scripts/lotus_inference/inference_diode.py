...
def main():
    # NYU dataset paths
    tar_path = 'lotus/datasets/eval/depth/diode/diode_val.tar'
    filename_list_path = 'lotus/datasets/eval/depth/data_split/diode/diode_val_all_filename_list.txt'
    output_file = 'outputs/lotus/diode_depth_descriptions.json'
