...
def main():
    ...
    train_dataset_vkitti = VKITTIDataset(args.train_data_dir_vkitti, transform_vkitti, args.norm_type, truncnorm_min=args.truncnorm_min, text_descriptions_path=args.vkitti_text_descriptions_path)
