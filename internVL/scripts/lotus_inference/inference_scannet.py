...
def main():
    # NYU dataset paths
    tar_path = 'lotus/datasets/eval/depth/scannet/scannet_val_sampled_800_1.tar'
    filename_list_path = 'lotus/datasets/eval/depth/data_split/scannet/scannet_val_sampled_list_800_1.txt'
    output_file = 'outputs/lotus/scannet_depth_descriptions.json'
