...
def find_all_images(base_dir):
    """
    Find all JPG images under any 'rgb' directory in the vkitti structure
    """
    base_path = Path(base_dir)
    image_files = []
    
    # Find all directories named 'rgb'
    for rgb_dir in base_path.rglob('rgb'):
        if rgb_dir.is_dir():
            # Get all jpg files recursively under this rgb directory
...
def main():
    base_dir = 'lotus/data/vkitti'
    output_file = 'outputs/lotus/vkitti_depth_descriptions.json'
