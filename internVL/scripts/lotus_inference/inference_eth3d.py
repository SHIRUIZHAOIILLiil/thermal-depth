...
def main():
    # NYU dataset paths
    tar_path = 'lotus/datasets/eval/depth/eth3d/eth3d.tar'
    filename_list_path = 'lotus/datasets/eval/depth/data_split/eth3d/eth3d_filename_list.txt'
    output_file = 'outputs/lotus/eth3d_depth_descriptions.json'
