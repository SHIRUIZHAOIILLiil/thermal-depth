...
python Marigold/eval.py \
    ...
    --prediction_dir experiments/depth/eval/e2e_ft/$checkpoint/kitti_eigen_test/prediction \
    --output_dir experiments/depth/eval/e2e_ft/$checkpoint/kitti_eigen_test/eval_metric